...
export default function Portfolio2() {
  return (
    <div id="portfolio2" className="portfolio2-section">
      <header>
        <h3>PortFolio2</h3>
      </header>
      <div className="container">
        <div className="port2-title">
          <h3>홈페이지</h3>
        </div>
        ...
        <div className="port2-tool">
          <h3>Use Skill</h3>
          <div className="port2-skill">
        ...
        <div className="homee-buttons">
          <Link to="/portfolio3">
            <button className="btn-primary">port3</button>
          </Link>
        </div>
      </div>
    </div>
