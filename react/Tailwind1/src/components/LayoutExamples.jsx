    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Flexbox와 Grid를 활용한 다양한 레이아웃입니다.
        </p>
      </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((num) => (
            <div
              key={num}
              className="bg-purple-100 border-2 border-purple-300 rounded-lg p-6 text-center"
            >
        ...
        <div className="flex gap-4 h-64">
          <div className="w-64 bg-gray-800 text-white rounded-lg p-6">
            ...
            <ul className="space-y-2">
              <li className="hover:bg-gray-700 p-2 rounded cursor-pointer transition">
                메뉴 1
              </li>
              <li className="hover:bg-gray-700 p-2 rounded cursor-pointer transition">
                메뉴 2
