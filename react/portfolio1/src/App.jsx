...
export default function App() {
  ...
  // 핵심 동작: 지정된 인덱스의 ref를 찾아 (sections[index]), 실제 DOM 요소(?.current)의 상단이 화면 상단에 맞춰
  // 부드럽게(behavior: 'smooth', block: 'start') 보이도록 스크롤합니다.
  ...
  return (
    <div className="app">
      ...
      <section ref={aboutRef} className="section section-hero">
        <div className="section-content">
          <h2 className="slide-in-left">About Us</h2>
          <p className="slide-in-left">
            스크롤할때마다 부드러운 효과가 적용됩니다.
          </p>
          <div className="cards">
